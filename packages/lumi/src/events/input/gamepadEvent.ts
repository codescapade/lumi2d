...
export class GamepadEvent extends Event {
   ...
   */
  static readonly CONNECTED = new EventType(GamepadEvent, 'lumi_gamepad_connected');

  /**
   * Gamepad disconnected type.
   */
  static readonly DISCONNECTED = new EventType(GamepadEvent, 'lumi_gamepad_disconnected');

  /**
   * Gamepad axis (joysticks/triggers) changed type.
   */
  static readonly AXIS_CHANGED = new EventType(GamepadEvent, 'lumi_gamepad_axis_changed');

  /**
   * Gamepad button pressed type.
   */
  static readonly BUTTON_PRESSED = new EventType(GamepadEvent, 'lumi_gamepad_button_pressed');

  /**
   * Gamepad button released type.
   */
  static readonly BUTTON_RELEASED = new EventType(GamepadEvent, 'lumi_gamepad_button_released');
