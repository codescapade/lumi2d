...
export class TouchEvent extends Event {
   ...
   * Touch pressed type.
   */
  static readonly PRESSED = new EventType(TouchEvent, 'lumi_touch_pressed');

  /**
   * Touch released type.
   */
  static readonly RELEASED = new EventType(TouchEvent, 'lumi_touch_released');

  /**
   * Touch moved type.
   */
  static readonly MOVED = new EventType(TouchEvent, 'lumi_touch_moved');
