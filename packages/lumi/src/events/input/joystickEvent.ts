...
export class JoystickEvent extends Event {
   ...
   */
  static readonly CONNECTED = new EventType(JoystickEvent, 'lumi_joystick_connected');

  /**
   * Joystick disconnected type.
   */
  static readonly DISCONNECTED = new EventType(JoystickEvent, 'lumi_joystick_disconnected');

  /**
   * Joystick axis changed type.
   */
  static readonly AXIS_CHANGED = new EventType(JoystickEvent, 'lumi_joystick_axis_changed');

  /**
   * Joystick hat changed type.
   */
  static readonly HAT_CHANGED = new EventType(JoystickEvent, 'lumi_joystick_hat_changed');

  /**
   * Joystick button pressed type.
   */
  static readonly BUTTON_PRESSED = new EventType(JoystickEvent, 'lumi_joystick_button_pressed');

  /**
   * Joystick button released type.
   */
  static readonly BUTTON_RELEASED = new EventType(JoystickEvent, 'lumi_joystick_button_released');
