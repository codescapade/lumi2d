...
import { LumiMath, Point, Rectangle } from '../math';
          ...
          if (body.bodyType !== 'static') {
            ...
            if (body.bodyType === 'dynamic') {
              ...
              if (body.maxVelocity.x !== 0) {
                body.velocity.x = LumiMath.clamp(body.velocity.x, -body.maxVelocity.x, body.maxVelocity.x);
              }

              if (body.maxVelocity.y !== 0) {
                body.velocity.y = LumiMath.clamp(body.velocity.y, -body.maxVelocity.y, body.maxVelocity.y);
              }
            }
