...
export class Packer {
   ...
   */
  constructor(rects: Rect[], packMethod: PackMethod, maxWidth: number, maxHeight: number) {
    this.rects = rects;
   ...
   */
  private placeRect(rect: Rect): boolean {
    if (this.packMethod === 'basic') {
   ...
   */
  private findPlace(startColumn: number, startRow: number, rect: Rect): boolean {
